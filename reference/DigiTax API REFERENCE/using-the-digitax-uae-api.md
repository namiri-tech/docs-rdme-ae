...
<Cards columns={1}>
  ...
  <Card title="Explore core DigiTax UAE API endpoints" icon="fa-plug">
    * Business context
      * GET [/info](https://ae.docs.digitax.tech/reference/get_info)
    * Parties
      * GET [/parties](https://ae.docs.digitax.tech/reference/get_parties)
      * POST [/parties](https://ae.docs.digitax.tech/reference/post_parties)
      * GET [/parties/{id}](https://ae.docs.digitax.tech/reference/get_parties_id)
      * PUT [/parties/{id}](https://ae.docs.digitax.tech/reference/put_parties_id)
    * Items
      * GET [/items](https://ae.docs.digitax.tech/reference/get_items)
      * POST [/items](https://ae.docs.digitax.tech/reference/post_items)
      * GET [/items/{id}](https://ae.docs.digitax.tech/reference/get_items_id)
    * Invoices
      * GET [/invoices](https://ae.docs.digitax.tech/reference/get_invoices)
      * POST [/invoices](https://ae.docs.digitax.tech/reference/post_invoices)
      * GET [/invoices/{id}](https://ae.docs.digitax.tech/reference/get_invoices_id)
    * Credit Notes
      * GET [/credit-notes](https://ae.docs.digitax.tech/reference/get_credit-notes)
      * POST [/credit-notes](https://ae.docs.digitax.tech/reference/post_credit-notes)
      * GET [/credit-notes/{id}](https://ae.docs.digitax.tech/reference/get_credit-notes_id)
    * Suppliers
      * GET [/debit-notes](https://ae.docs.digitax.tech/reference/get_debit-notes)
      * POST [/debit-notes](https://ae.docs.digitax.tech/reference/post_debit-notes)
      * GET [/debit-notes/{id}](https://ae.docs.digitax.tech/reference/get_debit-notes_id)
    * Self-Billed Invoices
      * GET [/self-billed-invoices](https://ae.docs.digitax.tech/reference/get_self-billed-invoices)
      * POST [/self-billed-invoices](https://ae.docs.digitax.tech/reference/post_self-billed-invoices)
      * GET [/self-billed-invoices/{id}](https://ae.docs.digitax.tech/reference/get_self-billed-invoices_id)
    * Self-Billed Credit Notes
      * GET [/self-billed-credit-notes](https://ae.docs.digitax.tech/reference/get_self-billed-credit-notes)
      * POST [/self-billed-credit-notes](https://ae.docs.digitax.tech/reference/post_self-billed-credit-notes)
      * GET [/self-billed-credit-notes/{id}](https://ae.docs.digitax.tech/reference/get_self-billed-credit-notes_id)
  </Card>
</Cards>
