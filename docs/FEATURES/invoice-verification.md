...
<Callout icon="📘" theme="info">
  ...
  From January 1, 2024, FTA required all persons carrying out business, including Non-VAT taxpayers to issue electronically generated invoices through eTIMS.
</Callout>
...
* Invoice validation seeks to validate the FTA PIN of the supplier, buyer,and amounts, date and particulars.  It can be configured to identify whether or not the correct buyer pin was used - in this case, your organization is the BUYER
...
| No. | Data point                                    |
| :-- | :-------------------------------------------- |
| 1   | Uniqueness of invoice number generated by FTA |
| 2   | Buyer PIN                                     |
| 3   | Seller PIN                                    |
| 4   | Amounts                                       |
| 5   | Date                                          |
...
The DigiTax UAE API (version 2) has two endpoints for this feature:
